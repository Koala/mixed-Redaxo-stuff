#!/bin/sh
#
# Rechteanpassung fuer Redaxo ab 4.4
#
...
chmod $VERZEICHNIS_RECHTE redaxo/include/addons/cronjob/logs
...
chmod $DATEI_RECHTE redaxo/include/addons/tinymce/config.inc.php
